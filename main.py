...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        "👋 Salut! Sunt asistentul tău de conținut.\n\nCe vrei să generez azi?",
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == "idei":
        ...
        response = genereaza(
            ...
            "Fiecare idee: titlu scurt + unghi narativ unic. "
        ...
        await query.edit_message_text(
            "📝 *Generare script*\n\n"
            "Trimite-mi numele modelului sau subiectul:\n\n"
            "• `McLaren Senna`\n"
        ...
        response = genereaza(
            ...
            "Fiecare pe o linie separată. Abordări: întrebare, afirmație șocantă, confesiune, cifră, provocare."
        )
...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    response = genereaza(
        ...
        f"Stil personal, sincer, fără să vândă direct. 150-250 cuvinte. "
        f"La final: 'Hook sugerat:' cu o variantă pentru primele 3 secunde."
    )
